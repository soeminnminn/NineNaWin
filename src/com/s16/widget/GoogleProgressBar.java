...
import com.s16.drawing.GoogleMusicDicesDrawable;
import com.s16.drawing.NexusRotationCrossDrawable;
...
public class GoogleProgressBar extends ProgressBar {
    ...
    public GoogleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int typeIndex = a.getInteger(R.styleable.GoogleProgressBar_type, context.getResources().getInteger(R.integer.gpb_default_type));
        final int colorsId = a.getResourceId(R.styleable.GoogleProgressBar_colors, R.array.gpb_google_colors);
        a.recycle();
