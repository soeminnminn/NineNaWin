...
public class RoundRectDrawableWithShadow extends Drawable {
	...
	private static final int SHADOW_END_COLOR = 0x03000000;
	private static final float INSET_SHADOW = 1.0f;
    ...
    * */
    ...
    public RoundRectDrawableWithShadow(Resources resources, int backgroundColor, float topRadius,
        ...
        mInsetShadow = (int)convertDpToPixel(INSET_SHADOW, resources);
