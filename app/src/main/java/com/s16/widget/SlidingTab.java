...
public class SlidingTab extends ViewGroup {
    private static final String LOG_TAG = SlidingTab.class.getSimpleName();
    ...
    private static class Slider {
         ...
         */
        public void measure() {
            tab.measure(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
    ...
    private void startAnimating(final boolean holdAfter) {
        ...
        final Animation trans1 = new TranslateAnimation(0, dx, 0, dy);
        trans1.setDuration(ANIM_DURATION);
        trans1.setInterpolator(new LinearInterpolator());
        trans1.setFillAfter(true);
        
        final Animation trans2 = new TranslateAnimation(0, dx, 0, dy);
